...
accelerate launch --multi_gpu --num_processes=2 --num_machines=1 \
    ...
    --log_file logs/log1106.txt \
    --output_dir=/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/ckpts/text-to-video-synthesis/cn_spatial_frozen_llava/output
