...
accelerate launch --multi_gpu --num_processes=4 --num_machines=1 \
    ...
    --dataset_file ../mydata/emoticon_caption_llava.original.json \
    --log_file logs/log1203_sta_original_10wstep_batch16.txt \
    --output_dir=/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/ckpts/text-to-video-synthesis/sta_1203_original_10wstep_batch16/output
