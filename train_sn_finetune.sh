...
accelerate launch --multi_gpu --num_processes=4 --num_machines=1 \
    ...
    --dataset_file ../mydata/emoticon_caption_llava.top33w_B.json \
    --log_file logs/log1210_base_B_100wstep_batch16.txt \
    --output_dir=/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/ckpts/text-to-video-synthesis/base_1210_B_100wstep_batch16/output
