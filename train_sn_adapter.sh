...
#     --dataset_file ../mydata/emoticon_caption_llava.top33w.json \
#     --log_file logs/log1213_100wstep_batch16.txt \
#     --output_dir=/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/ckpts/text-to-video-synthesis/adapter_1213_100wstep_batch16/output
...
accelerate launch --multi_gpu --num_processes=4 --num_machines=1 \
    ...
    --checkpointing_steps=5000 \
    --dataset_file ../mydata/emoticon_caption_llava.top33w.json \
    --log_file logs/log1214_100wstep_batch16_st.txt \
    --output_dir=/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/ckpts/text-to-video-synthesis/adapter_1213_100wstep_batch16_st/output