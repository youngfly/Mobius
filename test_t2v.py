...
# from vldm_parallel import CNTextToVideoSDPipeline, UNet3DConditionModel
from vldm_series import CNTextToVideoSDPipeline, UNet3DConditionModel
...
def main():
    ...
    # our load model
    print("*******************************")
    unet_path = '/mnt/chongqinggeminiceph1fs/geminicephfs/wx-mm-spr-xxxx/acceleryang/yyr/.cache/huggingface/hub/models--damo-vilab--text-to-video-ms-1.7b/snapshots/338683c3175cde59b407a699af8fe68f4a2b8f74/unet/diffusion_pytorch_model.bin'
    ...
    logger.info(args.resume_from_checkpoint)
